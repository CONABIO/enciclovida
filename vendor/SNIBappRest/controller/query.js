...
function EspeciesEstado(req) {
    ...
    return new Promise((resolve, reject) => {
        ...
        .with('anfibios', knex.raw(`SELECT spid, idnombrecatvalido, COUNT(*) AS COUNT FROM snibanfigw WHERE EXISTS ( SELECT 1 FROM estados WHERE entid = '${entid}' AND entid = snibanfigw.entid ) AND idnombrecatvalido <> '' GROUP BY spid, idnombrecatvalido`))
            ...
            /*.with('bacterias', knex.raw(`SELECT spid, idnombrecatvalido, COUNT (*) AS COUNT FROM snibbactgw WHERE EXISTS ( SELECT 1 FROM estados WHERE entid = '${entid}' AND entid = snibanfigw.entid ) AND idnombrecatvalido <> '' GROUP BY spid, idnombrecatvalido`))
            .with('hongos', knex.raw(`SELECT spid, idnombrecatvalido, COUNT (*) AS COUNT FROM snibhonggw WHERE EXISTS ( SELECT 1 FROM estados WHERE entid = '${entid}' AND entid = snibanfigw.entid ) AND idnombrecatvalido <> '' GROUP BY spid, idnombrecatvalido`))
            .with('invertebrados', knex.raw(`SELECT spid, idnombrecatvalido, COUNT (*) AS COUNT FROM snibinvegw WHERE EXISTS ( SELECT 1 FROM estados WHERE entid = '${entid}' AND entid = snibanfigw.entid ) AND idnombrecatvalido <> '' GROUP BY spid, idnombrecatvalido`))
            .with('mamiferos', knex.raw(`SELECT spid, idnombrecatvalido, COUNT (*) AS COUNT FROM snibmamigw WHERE EXISTS ( SELECT 1 FROM estados WHERE entid = '${entid}' AND entid = snibanfigw.entid ) AND idnombrecatvalido <> '' GROUP BY spid, idnombrecatvalido`))
            .with('peces', knex.raw(`SELECT spid, idnombrecatvalido, COUNT (*) AS COUNT FROM snibpecegw WHERE EXISTS ( SELECT 1 FROM estados WHERE entid = '${entid}' AND entid = snibanfigw.entid ) AND idnombrecatvalido <> '' GROUP BY spid, idnombrecatvalido`))
            .with('plantas', knex.raw(`SELECT spid, idnombrecatvalido, COUNT (*) AS COUNT FROM snibplangw WHERE EXISTS ( SELECT 1 FROM estados WHERE entid = '${entid}' AND entid = snibanfigw.entid ) AND idnombrecatvalido <> '' GROUP BY spid, idnombrecatvalido`))
            .with('protoctistas', knex.raw(`SELECT spid, idnombrecatvalido, COUNT (*) AS COUNT FROM snibprotgw WHERE EXISTS ( SELECT 1 FROM estados WHERE entid = '${entid}' AND entid = snibanfigw.entid ) AND idnombrecatvalido <> '' GROUP BY spid, idnombrecatvalido`))
            .with('reptiles', knex.raw(`SELECT spid, idnombrecatvalido, COUNT (*) AS COUNT FROM snibreptgw WHERE EXISTS ( SELECT 1 FROM estados WHERE entid = '${entid}' AND entid = snibanfigw.entid ) AND idnombrecatvalido <> '' GROUP BY spid, idnombrecatvalido`))*/
            .with('total', knex.raw(
                    `
