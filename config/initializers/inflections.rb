...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  inflect.irregular 'piplanta', 'piplantas'
  inflect.irregular 'piimagen', 'piimagenes'
  inflect.irregular 'pibibliografia', 'pibibliografias'
  inflect.irregular 'pi_planta', 'pi_plantas'
  inflect.irregular 'pi_imagen', 'pi_imagenes'
  inflect.irregular 'pi_bibliografia', 'pi_bibliografias'
