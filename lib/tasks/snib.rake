namespace :snib do
  ...
  namespace :especies do
    ...
    task estado: :environment do
      ...
      Rails.logger.debug "[DEBUG] - Generando cache de especies a nivel de estado"
      geo = Geoportal::Snib.new
    ...
    task municipio: :environment do
      ...
      Rails.logger.debug "[DEBUG] - Generando cache de especies a nivel de municipio"
      geo = Geoportal::Snib.new
    ...
    task anp: :environment do
      ...
      Rails.logger.debug "[DEBUG] - Generando cache de especies a nivel de anp"
      geo = Geoportal::Snib.new
