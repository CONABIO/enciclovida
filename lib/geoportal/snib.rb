module Geoportal
  class Snib < GeoportalAbs
    ...
    def self.actualiza_idnombrecatvalido
      ids = Geoportal::Snib.all.select(:idnombrecatvalido).where("idnombrecatvalido IS NOT NULL").group(:idnombrecatvalido).map(&:idnombrecatvalido).sort
