class UsuarioRolesController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @usuario_rol.save
          format.html { redirect_to usuario_roles_path, notice: 'El Rol fue añadido al usuario exitosamente.' }
    ...
    def update
      respond_to do |format|
        if @usuario_rol.update(usuario_rol_params)
          format.html { redirect_to usuario_roles_path, notice: 'El Rol del usuario se actualizo correctamente.' }
    ...
    def destroy
      @usuario_rol.destroy
      respond_to do |format|
        format.html { redirect_to usuario_roles_url }
        format.json { head :no_content }
      end
    end
