class RolesCategoriasContenidoController < ApplicationController
  ...
  def index
    @roles_categorias_contenido = RolCategoriasContenido.all
  end
  ...
  def create
    ...
    respond_to do |format|
      if @rol_categorias_contenido.save
        format.html { redirect_to @rol_categorias_contenido, notice: 'Rol categorias contenido was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @rol_categorias_contenido.update(rol_categorias_contenido_params)
        format.html { redirect_to @rol_categorias_contenido, notice: 'Rol categorias contenido was successfully updated.' }
  ...
  private
    ...
    def set_rol_categorias_contenido
      @rol_categorias_contenido = RolCategoriasContenido.find(params[:id])
    end
