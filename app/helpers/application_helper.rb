  ...
  def tituloNombreCientifico(taxon, params={}, link_params={})
    ...
    if I18n.locale.to_s == 'es-cientifico'
      ...
      when 'link-inline-clasificacion'
        "#{"<text class='f-cat-clasificacion'>[#{taxon.nombre_categoria_taxonomica[0].upcase}]</text>"} <span class='f-nom-clasificacion'>#{nombre_comun}</span> <b><i>#{link_to nombre_cientifico.sanitize.html_safe, especie_path(taxon), link_params}</i></b>".html_safe
      else
