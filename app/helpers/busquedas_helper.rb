module BusquedasHelper
  ...
  def radioGruposIconicos
    ...
    iconos.each do |taxon|  # Para tener los grupos ordenados
      ...
      radios << "<span title=\"#{ic.nombre_comun_principal}\" class=\"#{taxon.nombre_cientifico.parameterize}-ev-icon #{taxon.nombre_cientifico.parameterize} btn btn-xs btn-basica btn-title #{}\" id_icono=\"#{taxon.id}\"></span>"
      radios << "</label>"
