...
adicionales.foto_principal, adicionales.nombre_comun_principal, adicionales.icono, adicionales.nombre_icono, adicionales.color_icono') }
    #categoria_taxonomica_id, nombre_categoria_taxonomica') }
  # select y joins basicos que contiene los campos a mostrar por ponNombreCientifico
  scope :datos_basicos, -> { select_basico.especies_join.categoria_taxonomica_join.adicional_join }
