class Plantid::Planta < Plantidabs
  ...
  has_many :bibliografiaplantids, class_name: 'Plantid::Bibliografiaplantid', through: :plantabibliografias, foreign_key: :bibliografia_id
  has_many :catalogo, through: :plantacatalogos, source: :catalogo
  has_many :imagen, dependent: :destroy, through: :plantaimagenes

  accepts_nested_attributes_for :bibliografiaplantids, :reject_if => :all_blank, :allow_destroy => true
