class Plantid::PiPlanta < Plantid
  ...
  has_many :piplantabibliografias, class_name: 'Plantid::PiPlantaBibliografia', inverse_of: :piplanta
  has_many :piplantacatalogos, class_name: 'Plantid::PiPlantaCatalogo', inverse_of: :planta
  has_many :piplantaimagenes, class_name: 'Plantid::PiPlantaImagen', inverse_of: :planta
  has_many :pibibliografias, class_name: 'Plantid::PiBibliografia', through: :piplantabibliografias, foreign_key: :bibliografia_id
  has_many :picatalogo, through: :piplantacatalogos, source: :picatalogo
  has_many :pi_imagen, class_name: 'Plantid::PiImagen', dependent: :destroy, through: :piplantaimagenes
  ...
  accepts_nested_attributes_for :pi_imagen, :reject_if => :all_blank, :allow_destroy => true
