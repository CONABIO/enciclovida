...
Arachnida Insecta Mollusca Crustacea Annelida Myriapoda Echinodermata Cnidaria Porifera)
  ...
  BUSCADORES = {
		  clasificacion: {url: "/explora-por-clasificacion", nombre: "Clasificación", titulo: "por clasificación taxonómica", descripcion: "¡Explora toda la clasificación taxonómica desde reinos hasta especies!"},
		  region: {url: "/explora-por-region", nombre: "Región", titulo: "por región", descripcion: "Realiza búsquedas por estados, municipios o áreas naturales protegidas."},
		  usos: {url: "/busquedas/resultados?utf8=%E2%9C%93&nombre=&busqueda=avanzada&id=&uso%5B%5D=11-4-0-0-0-0-0&uso%5B%5D=11-16-0-0-0-0-0&uso%5B%5D=11-5-0-0-0-0-0&uso%5B%5D=11-40-1-0-0-0-0&uso%5B%5D=11-40-2-0-0-0-0&uso%5B%5D=11-8-0-0-0-0-0&uso%5B%5D=11-9-0-0-0-0-0&uso%5B%5D=11-10-0-0-0-0-0&uso%5B%5D=11-11-0-0-0-0-0&uso%5B%5D=11-13-0-0-0-0-0&uso%5B%5D=11-15-0-0-0-0-0&uso%5B%5D=11-14-0-0-0-0-0&por_pagina=50&commit=", nombre: "Usos", titulo: "por usos", descripcion: "Listado de todas las especies a las cuales se tiene un uso asignado."},
		  "en-riesgo" => {url: "/busquedas/resultados?utf8=%E2%9C%93&nombre=&busqueda=avanzada&id=&edo_cons%5B%5D=16&edo_cons%5B%5D=14&edo_cons%5B%5D=15&edo_cons%5B%5D=17&edo_cons%5B%5D=25&edo_cons%5B%5D=26&edo_cons%5B%5D=27&edo_cons%5B%5D=28&edo_cons%5B%5D=29&edo_cons%5B%5D=1102&edo_cons%5B%5D=1103&edo_cons%5B%5D=1104&edo_cons%5B%5D=22&edo_cons%5B%5D=23&edo_cons%5B%5D=24&por_pagina=50&commit=", nombre: "En riesgo", titulo: "de especies en riesgo", descripcion: "Navega por las especies que tienen asociada una categoría de riesgo ya sea nacional o internacional."},
		  distribucion: {url: "/busquedas/resultados?utf8=%E2%9C%93&nombre=&busqueda=avanzada&id=&dist%5B%5D=3&dist%5B%5D=7&dist%5B%5D=10&dist%5B%5D=6&por_pagina=50&commit=", nombre: "Distribución", titulo: "por tipo de distribución", descripcion: "Listado de especies que tienen un tipo de distribución asignado (endémica, nativa, exótica o exótica invasora)."},
		  "exotica-invasora" => {url: "/exoticas-invasoras", nombre: "Exóticas invasoras", titulo: "de especies exóticas invasoras", descripcion: "Listado de especies catalogadas como exóticas invasoras en el país."},
		  "peces-mariscos-comerciales" => {url: "/peces", nombre: "Consumo marino responsable", titulo: "de peces y mariscos comerciales", descripcion: "Utiliza el semáforo de consumo responsable, donde puedes hallar información sobre pesquerías sustentables y sus criterios de pesca"},
		  avanzada: {url: "/avanzada", nombre: "Avanzada", titulo: "avanzada", descripcion: "Engloba la mayoría de las búsquedas anteriores en una sola, también puedes buscar por el tipo de ambiente, la distribución reportada en literatura y por grupo icónico."} }
