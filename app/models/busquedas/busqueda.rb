...
Arachnida Insecta Mollusca Crustacea Annelida Myriapoda Echinodermata Cnidaria Porifera)
  ...
  BUSCADORES = {
		  ...
		  exotica: {url: "/exoticas-invasoras", nombre: "Exóticas invasoras", titulo: "de especies exóticas invasoras", descripcion: "Listado de especies catalogadas como exóticas invasoras en el país."},
