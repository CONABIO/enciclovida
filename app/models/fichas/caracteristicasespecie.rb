...
=begin
	...
	belongs_to :t_habitatAntropico,-> {where('cat_preguntas.idpregunta = ?', 1)}, class_name: 'Fichas::Cat_Preguntas', foreign_key: :idopcion, primary_key: :idopcion
	...
	belongs_to :t_suelo,-> {where('cat_preguntas.idpregunta = ?', 6)}, :class_name => 'Fichas::Cat_Preguntas', :foreign_key => 'idopcion', :primary_key => :idopcion
	belongs_to :t_ecorregionMarinaN1,-> {where('cat_preguntas.idpregunta = ?', 44)}, class_name: 'Fichas::Cat_Preguntas', :foreign_key => 'idopcion', :primary_key => :idopcion
	belongs_to :t_zonaVida,-> {where('cat_preguntas.idpregunta = ?', 43)}, class_name: 'Fichas::Cat_Preguntas', :foreign_key => 'idopcion', :primary_key => :idopcion

	# LAS DESDE HISTORIA NATURAL
	...
	belongs_to :t_mecanismos,-> {where('cat_preguntas.idpregunta = ?', 33)}, class_name: 'Fichas::Cat_Preguntas', :foreign_key => 'idopcion'
	belongs_to :t_efectoimpactosei,-> {where('cat_preguntas.idpregunta = ?', 34)}, class_name: 'Fichas::Cat_Preguntas', :foreign_key => 'idopcion'
	belongs_to :t_intensidadimpactosei,-> {where('cat_preguntas.idpregunta = ?', 35)}, class_name: 'Fichas::Cat_Preguntas', :foreign_key => 'idopcion'
	belongs_to :t_especiesasociadassei,-> {where('cat_preguntas.idpregunta = ?', 37)}, class_name: 'Fichas::Cat_Preguntas', :foreign_key => 'idopcion'
	belongs_to :t_plasticidadsei,-> {where('cat_preguntas.idpregunta = ?', 38)}, class_name: 'Fichas::Cat_Preguntas', :foreign_key => 'idopcion'
	belongs_to :t_platenciasei,-> {where('cat_preguntas.idpregunta = ?', 40)}, class_name: 'Fichas::Cat_Preguntas', :foreign_key => 'idopcion'
